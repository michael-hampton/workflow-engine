...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2017 at 05:25 PM
...
(13, 'fileupload', 'fileUpload', 0, 'file', 'Upload File', 0, 'form-control', '', '', NULL, '', ''),
...
(65, 'form[description]', 'form[description]', 0, 'text', 'Description', 0, 'form-control', '', 'Description', NULL, '', ''),
...
(68, 'description', 'form[description]', 0, 'text', 'Description', 0, 'form-control', '', 'Description', NULL, '', ''),
...
(99, 'form[name]', 'form[name]', 0, 'text', 'Name', 0, 'form-control', 'default value', 'Name', 22, '', ''),
(100, 'mikeid', 'select-mike', 0, 'select', 'Test Select Mike', 0, 'form-control', '', 'placeholder', NULL, '', ''),
(105, 'select-mike2', 'select-mike2', 0, 'select', 'Select', 29, 'form-control', '', 'placeholder 2', NULL, '', '');
