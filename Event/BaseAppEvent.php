 ...
 */
abstract class BaseAppEvent implements Persistent
{
    ...
    /**
     * The value for the case_uid field.
     * @var        string
     */
    protected $case_uid = '';
    ...
    private $arrayFieldDefinition = array(
        ...
        "CASE_UID" => array("type" => "string", "required" => true, "empty" => false, "accessor" => "getCase_uid", "mutator" => "setCaseUid"),
        "DEL_INDEX" => array("type" => "string", "required" => true, "empty" => true, "accessor" => "getDelIndex", "mutator" => "setDelIndex"),
        "EVN_UID" => array("type" => "string", "required" => true, "empty" => false, "accessor" => "getEvnUid", "mutator" => "setEvnUid"),
        "APP_EVN_ACTION_DATE" => array("type" => "string", "required" => true, "empty" => false, "accessor" => "getAppEvnActionDate", "mutator" => "setAppEvnActionDate"),
        "APP_EVN_ATTEMPTS" => array("type" => "string", "required" => true, "empty" => false, "accessor" => "getAppEvnAttempts", "mutator" => "setAppEvnAttempts"),
        "APP_EVN_LAST_EXECUTION_DATE" => array("type" => "int", "required" => false, "empty" => false, "accessor" => "getAppEvnLastExecutionDate", "mutator" => "setAppEvnLastExecutionDate"),
        "APP_EVN_STATUS" => array("type" => "string", "required" => true, "empty" => true, "accessor" => "getAppEvnStatus", "mutator" => "setAppEvnStatus"),
    );
